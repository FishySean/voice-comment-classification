...
# 默认路径
DEFAULT_PROMPT = "/Users/para_fish66/Desktop/语音评论/prompt/social_interaction_detection/版本1.txt"
DEFAULT_INPUT = "/Users/para_fish66/Desktop/语音评论/data/testing_data/social_interaction_detection/评测集0606.csv"
...
def main():
    ...
    parser.add_argument(
        "--run-name", type=str, default="第一次评测（prompt版本1）",
        help="本次评测名称（默认: 第一次评测（prompt版本1））"
    )
    parser.add_argument(
