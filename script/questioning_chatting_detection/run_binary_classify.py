...
DEFAULT_PROMPT = "/Users/para_fish66/Desktop/语音评论/prompt/questioning_chatting_detection/版本3.txt"
...
def main():
    ...
    parser.add_argument("--run-name", type=str, default="第四次评测（prompt版本3，评测集0606_v2）", help="本次评测名称")
